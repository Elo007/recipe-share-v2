...
if (userCount === 0) {
  ...
  const recipesData = [
    ...
    },
    {
      ...
      image: 'https://images.unsplash.com/photo-1606101273945-e9eba83d8062?w=800',
    ...
    },
    {
      ...
      image: 'https://images.unsplash.com/photo-1554520735-0a6b8b6ce8b5?w=800',
    ...
    },
    {
      ...
      image: 'https://images.unsplash.com/photo-1612180356220-555e3da77c0e?w=800',
    ...
    },
    {
      ...
      image: 'https://images.unsplash.com/photo-1583529921582-72eee76123a3?w=800',
    ...
    },
    {
      ...
      image: 'https://images.unsplash.com/photo-1551504734-1d59c8c1a4f2?w=800',
  ...
  for (const r of recipesData) {
    const recipe = insertRecipe.run(
      ...
      r.difficulty, r.image, r.isPaid ? 1 : 0, r.price, r.calories, r.protein, r.carbs, r.fat
    );
